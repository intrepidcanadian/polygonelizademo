export const withdrawTokenTemplate = `Given the recent messages and wallet information below:

{{recentMessages}}

Extract the parameters needed to withdraw tokens from AAVE v3 pool on Polygon.
...
- amount: The amount to withdraw as a string (e.g. "100")

...
export class WalletProvider {
    ...
    private currentChain: SupportedChain = "confluxESpaceTestnet";
...
const genChainsFromRuntime = (
    ...
    const confluxESpaceTestnet_rpcurl = runtime.getSetting("EVM_PROVIDER_URL");
    if (confluxESpaceTestnet_rpcurl) {
        const chain = WalletProvider.genChainFromName(
            "confluxESpaceTestnet",
            confluxESpaceTestnet_rpcurl
        );
        chains["confluxESpaceTestnet"] = chain;
    }
